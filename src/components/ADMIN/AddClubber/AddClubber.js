...
import {Container, Form, FormGroup, Label, Input, Row, Col, ButtonDropdown, DropdownToggle, DropdownMenu, DropdownItem, Button} from 'reactstrap';
        ...
        <Container>
          ...
          <Form>
            ...
            <FormGroup>
              ...
              <Input type='text' name='confirmPassword' onChange={this.onChange} value={this.state.confirmPassword}/>
            </FormGroup>
          </Form>
          <br/>
          <hr/>
          ...
          <Row>
              ...
              <FormGroup>
                ...
                <ButtonDropdown isOpen={this.state.committeeDropdown} toggle={this.toggleCommittee}>
                  <DropdownToggle caret color='info'>
                    {this.state.committee === '' ? 'Select Committee' : this.state.committee}
                  </DropdownToggle>
                  <DropdownMenu>
            ...
            <Col xs='auto'>
              <FormGroup>
                ...
                <ButtonDropdown isOpen={this.state.positionsDropdown} toggle={this.togglePositions}>
                  <DropdownToggle caret color='info'>
                  {this.state.position === '' ? 'Select Position' : this.state.position}
                  </DropdownToggle>
                  <DropdownMenu>
            ...
            <Col>
              <FormGroup>
                <Label>Project</Label>
                <Input type='text' name='project' onChange={this.onChange} value={this.state.project}/>
              </FormGroup>
            </Col>
          </Row>
          <Row>
            ...
            <FormGroup>
              ...
              <Input type='text' name='degree_program' onChange={this.onChange} value={this.state.degree_program}/>
            </FormGroup>
            <FormGroup>
          ...
          <Button color='success' onClick={this.addClubber}>Add Clubber</Button>
        </Container>
      </div>
    );
  }
