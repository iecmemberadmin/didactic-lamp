...
class EditPosition extends Component {
  ...
  componentWillMount() {
    axios.get(`https://clubberdb-api.herokuapp.com/positions/detail/?committee=${localStorage.getItem('committee')}&level=${localStorage.getItem('level')}&project=${localStorage.getItem('project')}`)
    .then(response => {
  ...
  submit = () => {
    ...
    axios.put(`https://clubberdb-api.herokuapp.com/positions/detail/?committee=${this.state.data.committee}&level=${this.state.data.level}&project=${this.state.data.project}`, this.state.data)
    .then(response => {
      this.props.history.push('/admin/primer/view');
    })
    .catch(error => {
    ...
    return(
      <div>
        ...
        <Container>
          ...
          <Button color='success' onClick={this.submit}>Edit Position</Button>
            ...
            <Col>
              ...
              <Row>
                <Col>
                  <InputGroup>
                    ...
                    <Input name='project' onChange={this.onChange} value={this.state.data.project}/>
                  </InputGroup>
                </Col>
                <Col>
                  <InputGroup>
                    ...
                    <Input name='number_of_people' min={0} max={100} type="number" step="1" onChange={this.onChange} value={this.state.data.number_of_people}/>
                  </InputGroup>
                </Col>
              </Row>
              <br/>
              ...
              <Row>
                <Col>
                  <InputGroup>
                    <InputGroupAddon addonType="prepend">
                      <InputGroupText>Resources (Helpful Links, Drives, etc.)</InputGroupText>
                    </InputGroupAddon>
